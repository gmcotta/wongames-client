...
export async function getStaticProps() {
  const descriptionHTML = `
    <div class="description">
      <a href="https://www.cyberpunk.net/en/news/39092/patch-1-3-list-of-changes">
        <img src="https://items.gog.com/not_a_cp/1.3patchbox.png">
      </a>
      <hr>
      <br>
      ...
      <br>
      <hr>
      <a target="“_blank”" href="https://lp.gog.com/cyberpunk-2077-hub/en">
